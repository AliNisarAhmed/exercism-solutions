defmodule TakeANumberDeluxe do
  ...
  def init(init_arg) do
    ...
    with {:ok, state} <-
           State.new(init_arg[:min_number], init_arg[:max_number], auto_shutdown_timeout) do
  ...
  def handle_call(:queue_new_number, _from, state) do
    with {:ok, new_number, new_state} <- TakeANumberDeluxe.State.queue_new_number(state) do
